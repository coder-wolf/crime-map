...
export default function Home() {
  ...
  return (
    <div className="relative w-full overflow-hidden" style={{ height: '100dvh' }}>
      ...
      {sidebarOpen && (
        <aside
          className="absolute top-0 left-0 h-full overflow-y-auto border-r border-zinc-200 bg-white dark:bg-zinc-950 dark:border-zinc-800 flex flex-col z-[9999] shadow-xl"
